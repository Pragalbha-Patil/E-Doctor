...
<head>
   ...
   <title>Complete Payment - E-doctor</title>
...
<body>
   ...
   <div class="container">
      ...
      <div class="row">
         <div class="col-lg-12 mt40">
            <div class="card-header" style="background: #0275D8;">
               <h2>Complete Payment - E-doctor</h2>
            </div>
         </div>
      </div>
      ...
      <form action="{{ url('pay') }}" method="POST" name="e-doctor">
         @csrf
         <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-12">
               <div class="form-group">
                  <strong>Token</strong>
                  <input type="text" name="token" class="form-control" placeholder="Enter token here">
               </div>
            </div>
            <div class="col-md-12">
               <div class="form-group">
